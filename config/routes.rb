...
MatildaCore::Engine.routes.draw do
  ...
  get 'authentication/verify-email-view', to: 'authentication#verify_email_view', as: 'authentication_verify_email_view'
  ...
  post 'profile/edit_useless_sessions_action', to: 'profile#edit_useless_sessions_action', as: :profile_edit_useless_sessions_action
  ...
  get 'memberships/manage-view/main', to: 'memberships#manage_view_main', as: 'memberships_manage_view_main'
  get 'memberships/manage-view/roles', to: 'memberships#manage_view_roles', as: 'memberships_manage_view_roles'
  get 'memberships/manage-view/machines', to: 'memberships#manage_view_machines', as: 'memberships_manage_view_machines'
